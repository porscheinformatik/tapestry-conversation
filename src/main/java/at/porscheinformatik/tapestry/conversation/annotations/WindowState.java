...
/**
 * Marker annotation for a field that is a <em>window state object</em> (WSO) as controlled by the
 * {@link org.apache.tapestry5.services.ApplicationStateManager}.
 * <p>
 * Works similar to {@link org.apache.tapestry5.annotations.SessionState} but puts objects into window state.
 */
@Target(FIELD)
@Documented
@Retention(RUNTIME)
